...
Use the MetaMask faucet to load testnet ETH on your Ethereum account for the Sepolia network.
...
In the compile script we'll also copy the generated [Application Binary Interface (ABI)](https://docs.soliditylang.org/en/develop/abi-spec.html) and binary to a file called `Demo.json`.
