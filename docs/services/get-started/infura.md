...
Snap development. Sign up for an account on the
...
After verification, you'll be directed to the [MetaMask Developer dashboard](dashboard/dashboard-placeholder.md)
...
<div class="left-align-container">
  <div class="img-large">
    <img
      src={require('@site/static/img/first-api-key.png').default}
    />
  </div>
</div>
...
[Configure security settings](dashboard/dashboard-placeholder.md) by selecting **Configure**.
This is optional.
...
<div className="left-align-container">
  <div className="img-large">
    <img
      src={require('@site/static/img/settings-tab.png').default}
      alt="Settings Tab"
    />
  </div>
</div>
...
<div class="left-align-container">
  <div class="img-large">
    <img
      src={require('@site/static/img/analytics.png').default}
    />
  </div>
</div>
...
[reviewing your API request stats](dashboard/dashboard-placeholder.md).

## 6. View your credit usage

The dashboard provides an overview of your daily credit usage. Select **View Usage**
for a [wider view of your credit usage](dashboard/dashboard-placeholder.md).

<div class="left-align-container">
  <div class="img-large">
    <img
      src={require('@site/static/img/view-usage.png').default}
    />
  </div>
</div>
...
- Set notifications for daily limits
