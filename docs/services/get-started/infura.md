...
After verification, you'll be directed to the [MetaMask Developer dashboard](https://dashboard.metamask.io/)
...
[Configure security settings](https://dashboard.metamask.io/) by selecting **Configure**.
This is optional.
...
[reviewing your API request stats](https://dashboard.metamask.io/).

## 6. View your credit usage

The dashboard provides an overview of your daily credit usage. Select **View Usage**
for a [wider view of your credit usage](https://dashboard.metamask.io/).
