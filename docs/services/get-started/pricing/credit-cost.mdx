...
// import CreditCostTable from '@site/src/components/CreditCost/CreditCostTable.js'; // Component not available in this project
...
2. **Fallback to the Ethereum method's credit value** - If no specific credit value is found for the network, the system applies the Ethereum method's credit value.
   Ethereum serves as the baseline for pricing core RPC methods.

3. **Fallback to the default credit value** - If the method is not found in the Ethereum table either, the system applies a default credit value.
...
{/\* <CreditCostTable methods="evm" />... - Component not available \*/}

### Trace methods

{/\* <CreditCostTable methods="evm_trace" />... - Component not available \*/}

### Filter methods

{/\* <CreditCostTable methods="evm_filter" />... - Component not available \*/}

### Debug methods

{/\* <CreditCostTable methods="evm_debug" />... - Component not available \*/}
...
{/\* <CreditCostTable methods="evm_subscription" />... - Component not available \*/}

## Linea

{/\* <CreditCostTable methods="linea" />... - Component not available \*/}

## Polygon

{/\* <CreditCostTable methods="polygon" />... - Component not available \*/}
...
{/\* <CreditCostTable methods="starknet" />... - Component not available \*/}

## ZKsync Era

{/\* <CreditCostTable methods="zksync" />... - Component not available \*/}

## Gas API

{/\* <CreditCostTable methods="gasApi" />... - Component not available \*/}
...
{/\* <CreditCostTable methods="bundler" />... - Component not available \*/}
