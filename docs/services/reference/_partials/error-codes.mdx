...
| -33300 | Too Many Requests              | You have surpassed your [user-defined key throughput limit setting](https://dashboard.metamask.io/). To make more requests, adjust your rate limit.                                                                      | Non-standard |
| -33400 | Too Many Requests              | You have surpassed your [user-defined key daily credit limit setting](https://dashboard.metamask.io/). To make more requests, adjust your daily quota limit.                                                             | Non-standard |
...
| 429  | Too Many Requests     | You have reached your plan's daily throughput limits, or [user-defined throughput limits](https://dashboard.metamask.io/). To continue making requests, reduce the requests per second, upgrade your plan, or review your user-defined limits. Refer to the [Avoid rate limiting](/services/how-to/avoid-rate-limiting) topic for more information. Example response: `"error": {"code": -32005, "message": "project ID request rate exceeded"}`. |
