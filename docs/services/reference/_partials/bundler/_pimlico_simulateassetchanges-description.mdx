...
and shows all balance changes including native currency, ERC-20, ERC-1155, and ERC-721 tokens. {/* <CreditCost network="bundler" method="pimlico_simulateAssetChanges" /> - Component not available */}
