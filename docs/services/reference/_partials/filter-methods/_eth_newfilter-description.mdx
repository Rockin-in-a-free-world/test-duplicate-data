...
To check if the state has changed, call [`eth_getFilterChanges`](../eth_getfilterchanges). {/* <CreditCost network="evm_filter" method="eth_newFilter" />... - Component not available */}
