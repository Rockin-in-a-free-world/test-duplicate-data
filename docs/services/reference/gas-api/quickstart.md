...
- A valid [Web3 API key](dashboard/dashboard-placeholder.md)
  and optional [API key secret](dashboard/dashboard-placeholder.md).
...
[API key secret](dashboard/dashboard-placeholder.md) to authenticate requests.
:::

## Create your script

The Gas API supports multiple request formats, and
