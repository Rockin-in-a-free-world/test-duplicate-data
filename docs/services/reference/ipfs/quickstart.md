...
Before you begin, ensure you have a valid [API key](dashboard/dashboard-placeholder.md) and
[API key secret](dashboard/dashboard-placeholder.md).
...
- **Monitor your usage**: Monitor your usage on the [MetaMask Developer dashboard](dashboard/dashboard-placeholder.md) to ensure you're not hitting your rate limits.
